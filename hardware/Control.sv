...
module ROM (
    ...
    localparam logic [`ROM_DATA_SIZE - 1 : 0] memory[`ROM_NUM_INST_SIZE] = {
        ...
        // Fetch
        `ROM_DATA_SIZE'b0_0_0_000_0_000_1_0_0_0_0_1_001_0_0_0000_0,  // MDR <- [PC]
...
module Control #(
    ...
    assign {Acc_Read, Acc_Write,
            Reg_Read, Reg_Read_Addr, Reg_Write, Reg_Write_Addr,
            Control_Read, Control_Write, Io_Read, IR_Write, IR_Read, MDR_Read,
            PC_Sel,
            ALU_In_1, ALU_In_2, ALU_Op_Sel, ALU_Out_Write} = CTRL;
