...
module ROM (
    ...
    always_comb begin
        read_reg_addr  = (read_addr != 4'h0) ? (`ROM_NOTHING - 3 - read_addr) : `ROM_NOTHING;
        write_reg_addr = (write_addr != 4'h0) ? (`ROM_NOTHING - write_addr) : `ROM_NOTHING;
    end
...
module Control #(
    ...
    logic [3 : 0] param_2, param_1, write_addr, read_addr;
    logic [7 : 0] instr;
